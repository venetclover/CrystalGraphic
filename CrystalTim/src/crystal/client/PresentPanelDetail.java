...
public class PresentPanelDetail extends JPanel {
	...
	public PresentPanelDetail(String[] files, JFrame parentFrame, String dir) {
		super();
		this.dir = dir;
		picNames = files;
	...
	public PresentPanelDetail(String[] files, JFrame parentFrame,String strPath, String dir) {
		super();
		this.dir = dir;
